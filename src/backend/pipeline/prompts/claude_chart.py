...
# ---------------------------------------------------------------------------
# Pipeline v2: Independent technical analyst (no sentiment/FMP injection)
# ---------------------------------------------------------------------------
...
def get_prompt_hash_v2() -> str:
    """Return the version hash of the v2 chart analysis prompt."""
    return prompt_hash(CHART_SYSTEM_PROMPT_V2)
