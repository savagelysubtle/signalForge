...
Chart-Img, sends the image to Claude Vision along with numerical TA
data from Phase 1 and strategy config, and returns a validated
``TechnicalAssessment``.
...
async def _call_claude_vision(
    ...
    *,
    ...
    Args:
        ...
        user_prompt: Per-ticker chart analysis request with TA context.
